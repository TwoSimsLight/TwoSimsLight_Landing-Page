...
mem_back_old = '''\.mem-back {
    background: radial-gradient(circle at 35% 30%, #ecfcce, #b5dc73 70%);
    box-shadow: inset -2px -2px 6px rgba(0,0,0,0.15), inset 3px 3px 6px rgba(255,255,255,0.8), 2px 3px 5px rgba(0,0,0,0.25);
}'''
import re
text = re.sub(r'\.mem-back\s*\{[^}]*\}', '''.mem-back {
